                    ...
                    <label for="defaultFormControlInput" class="form-label">Title</label>
                      <div class="input-group input-group-merge speech-to-text">
                        <input
                          ...
                          name="cat_title"
                          placeholder="Write or Say it"
                          aria-describedby="text-to-speech-addon"
                          value="<?= $get_category['cat_title']; ?>"
                          required
                        />
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="categories.php?edit=<?= $row['cat_id'] ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="categories.php?delete=<?= $row['cat_id'] ?>"
